...
const Input = ({ dark, onDarkToggle }) => {
  ...
  return (
    <div className='max-w-xl mx-auto'>
      <div className='flex justify-between mx-7 pt-8 sm:pt-14'>
      ...
      <div className='mt-11 mx-7 relative'>
        <input
          type='text'
        ...
        <div className='w-5 h-5 rounded-full absolute top-[50%] left-[20px] translate-y-[-50%] dark:border-veryDarkGrayishBlueInput border-[1px]'></div>
      </div>
    </div>
  );
};
