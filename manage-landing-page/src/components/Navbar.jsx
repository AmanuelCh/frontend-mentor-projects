  ...
  return (
    ...
    <div className="container mx-auto mt-10 px-6 flex justify-between items-center relative lg:py-6">
      ...
      <div className='md:hidden'>
        <img src={!isOpen ? openMenu : closeMenu} className='cursor-pointer' onClick={toggleMenu} alt="menu" />
      </div>

    </div>

    <img src={background} alt="" className="hidden background absolute -top-24 -right-24 -z-10 max-w-xl lg:max-w-2xl  sm:block" />

    <div className="md:hidden">
      <div className={`absolute flex-col items-center ${isOpen ? 'flex' : 'hidden'} self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md text-veryDarkBlue`}>
        <a href="#">Pricing</a>
        <a href="#">Product</a>
        <a href="#">About Us</a>
        <a href="#">Careers</a>
