      ...
      <div className="flex flex-col gap-12 md:gap-6 md:w-1/2">
        <div className="md:flex items-start gap-6">
          <div className="flex items-stretch md:items-start">
            ...
            <div className="bg-veryPaleRed w-full rounded-full -ml-8 -z-10 flex items-center md:hidden">
              <h3 className="ml-10 text-darkBlue text-[15px] font-semibold">
        ...
        <div className="md:flex items-start gap-6">
          <div className="flex items-stretch md:items-start">
            ...
            <div className="bg-veryPaleRed w-full rounded-full -ml-8 -z-10 flex items-center md:hidden">
              <h3 className="ml-10 text-darkBlue text-base font-semibold text-[15px]">
        ...
        <div className="md:flex items-start gap-6">
          <div className="flex items-stretch md:items-start">
            ...
            <div className="bg-veryPaleRed w-full rounded-full -ml-8 -z-10 flex items-center md:hidden">
              <h3 className="ml-10 text-darkBlue text-base font-semibold text-[13px]">
